/**
 * mid-codes.js — ITU Maritime Identification Digits (MID) table.
 *
 * The first 3 digits of a standard 9-digit ship MMSI identify the country
 * that issued it (a vessel's registered flag, not necessarily its owner's
 * nationality or current location). Source: ITU MID assignments (as
 * tabulated on Wikipedia's "Maritime identification digits" page). A few
 * codes are shared/ambiguous after country splits (e.g. the former
 * Netherlands Antilles' 306, now split three ways) — those are resolved to
 * a single label below rather than listed per-successor-state, since this
 * data is informational display only, not authoritative registry lookup.
 */
export const MID_TO_FLAG = {
  ...
  306: 'Curaçao / Sint Maarten / Bonaire, Sint Eustatius and Saba',
  307: 'Aruba',
  308: 'Bahamas',
  309: 'Bahamas',
  310: 'Bermuda',
